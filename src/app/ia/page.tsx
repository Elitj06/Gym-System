...
export default function IAVisionPage() {
  ...
  const [cameraKey, setCameraKey] = useState(0) // Force remount on camera switch
  ...
  const flipCamera = () => {
    ...
    setCameraKey(k => k + 1) // Force full remount of camera component
  }
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-2 flex-wrap">
                      ...
                      <button onClick={stop} className="px-3 py-1.5 bg-red-500/20 text-red-400 rounded-lg text-xs flex items-center gap-1.5">
                        <Square className="w-3.5 h-3.5" /> Parar e Gerar Relatório
                      </button>
                      <div className="ml-auto px-2 py-1 rounded text-xs font-bold" style={{ backgroundColor: scoreColor(score) + '20', color: scoreColor(score) }}>
